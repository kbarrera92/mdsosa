...
{
    public partial class frmVerViajesWP : frmBase
    {
        public frmVerViajesWP()
        {
            InitializeComponent();
        }
        ...
        private void frmVerViajesWP_Load(object sender, EventArgs e)
        {
            ...
            BL_Viajes.llenardgvviajeswp(dataGridView1);
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            {
                BL_Viajes.filtrarxclientewp(dataGridView1, txtbuscar.Text.Trim());
            }
            else
            {
                if (radioButtonpiloto.Checked)
                {
                    BL_Viajes.filtrarxpilotowp(dataGridView1, txtbuscar.Text.Trim());
                }
                else
                {
                    BL_Viajes.filtrarxusuariowp(dataGridView1, txtbuscar.Text.Trim());
                    if (radioButton1.Checked)
                    {
                        BL_Viajes.filtrarxnoviajewp(dataGridView1, txtbuscar.Text.Trim());
                    }
                }
            }
        }
        ...
        private void button5_Click(object sender, EventArgs e)
        {
            if (chkmes.Checked)
            {
                ...
                BL_Viajes.filtrarpormesregwp(dataGridView1, mes, anio);
            }
            else
            {
                if (chkfechas.Checked)
                {
                    ...
                    BL_Viajes.filtrarporfechaswp(dataGridView1, ini, fin);
                }
                else
                {
